...
nj=1
# language model order(n-gram quantity) 1 is enough for digits grammer
lm_order=1
...
#Compute best_wer
steps/scoring/score_kaldi_wer.sh data/test exp/mono/graph exp/mono/decode
...
#Compute best_wer
steps/scoring/score_kaldi_wer.sh data/test exp/tri1/graph exp/tri1/decode
